...
from keras.layers import Input, Activation, Convolution2D, ZeroPadding2D, BatchNormalization
...
def mobilenet(input_tensor):
    ...
    for i in range(5):
        x = DepthwiseConvolution2D(512, (3, 3), strides=(1, 1), padding='same', use_bias=False,
